...
export function BottomNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-4 left-1/2 -translate-x-1/2 z-30 h-[52px] w-fit min-w-[240px] bg-[#0c0c0c] border border-[#1c1c1c] rounded-pill flex items-center justify-center gap-4 px-6">
