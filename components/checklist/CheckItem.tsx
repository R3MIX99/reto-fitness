...
import { Camera, Check, Clock, Pencil } from "lucide-react";
...
export function CheckItem({ goal, check, onMark, onEdit, loading }: CheckItemProps) {
  ...
  return (
    <div className="flex items-center gap-3 py-2.5">
      ...
      <span
        ...
        style={{ color: isDone ? "var(--color-muted)" : "var(--color-fg)", textDecoration: isDone ? "line-through" : "none" }}
      >
