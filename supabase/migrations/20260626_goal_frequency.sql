-- Frecuencia de metas: una meta "once" solo cuenta en config.once_date; una
-- "monthly" solo el día config.day_of_month. Espeja exactamente goalAppliesOn
-- del cliente. Además se capan dieta/metas a 5 pts por seguridad.
